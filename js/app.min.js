...
$(".home-burger-btn").on("click", function () {
    $('.header-home-mobile-overlay').css('transition', 'all 0.3s');
    $('.header-home-mobile').css('transition', 'all 0.7s');
    setTimeout(() => {
        $('.header-home-mobile-overlay').css('width', '100%');
        $(".header-home-mobile").css('width', '100%');
    }, 0);
})

$(".header-home-mobile .close-btn").on("click", function () {
    $('.header-home-mobile-overlay').css('transition', 'all 0.7s');
    $('.header-home-mobile').css('transition', 'all 0.3s');
    setTimeout(() => {
        $('.header-home-mobile-overlay').css('width', '0%');
        $(".header-home-mobile").css('width', '0%');
    }, 0);
})
    $(function () {
